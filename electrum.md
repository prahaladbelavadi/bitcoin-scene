# [Electrum Wallet](https://electrum.org/#home)
    ...
    A desktop bitcoin wallet for Windows, Android, OSX and Linux.
...
# Wallet Security
    ...
    * [Do's and Don't s](https://en.bitcoin.it/wiki/Wallet_Security_Dos_and_Don%27ts)
    * [Securing your wallet](https://en.bitcoin.it/wiki/Securing_your_wallet)

# Reference:

    * [Bitcoin Wiki](https://en.bitcoin.it/wiki/Wallet)
